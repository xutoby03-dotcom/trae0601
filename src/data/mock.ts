...
export const MOCK_CARPOOLS: Carpool[] = [
  ...
  },
  {
    ...
    totalSeats: 4,
    passengers: [
      { id: 'u13', name: '王刚', joinedAt: futureDate(-55) },
      { id: 'u14', name: '孙梅', joinedAt: futureDate(-53) },
    ],
    totalCost: 160,
    allowLuggage: true,
    contact: '微信: wanggang88',
    status: 'departed',
    messages: [
      { id: 'm7', authorId: 'u13', authorName: '王刚', content: '准时出发，大家到了吗？', createdAt: futureDate(-49) },
    ],
    createdAt: futureDate(-56),
    publisherId: 'u13',
    publisherName: '王刚',
  },
  {
    ...
    departure: '阳光花园3号门',
    destination: '虹桥火车站',
    departureTime: futureDate(-72),
    totalSeats: 4,
    passengers: [
      { id: 'u15', name: '钱红', joinedAt: futureDate(-80) },
      { id: 'u16', name: '孔明', joinedAt: futureDate(-78) },
      { id: 'u17', name: '曹操', joinedAt: futureDate(-77) },
    ],
    totalCost: 120,
    allowLuggage: true,
    contact: '微信: qianhong_go',
    status: 'departed',
    messages: [],
    createdAt: futureDate(-82),
    publisherId: 'u15',
    publisherName: '钱红',
  },
]
