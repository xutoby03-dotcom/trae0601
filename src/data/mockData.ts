...
export const mockCases: PetCase[] = [
  {
    ...
    photos: [
      'https://picsum.photos/seed/doudou1/400/400',
      'https://picsum.photos/seed/doudou2/400/400',
    ],
    status: 'active',
    createdAt: yesterday,
  },
  {
    ...
    photos: [
      'https://picsum.photos/seed/huahua1/400/400',
    ],
    status: 'active',
  ...
  },
  {
    ...
    photos: [
      'https://picsum.photos/seed/dahuang1/400/400',
      'https://picsum.photos/seed/dahuang2/400/400',
      'https://picsum.photos/seed/dahuang3/400/400',
    ],
    status: 'active',
  ...
  },
  {
    ...
    photos: [
      'https://picsum.photos/seed/xiaobai1/400/400',
    ],
    status: 'active',
...
export const mockVisitRecords: VisitRecord[] = [
  {
    ...
    spirit: 3,
    woundPhotos: [
      'https://picsum.photos/seed/wound-huahua-1/400/400',
      'https://picsum.photos/seed/wound-huahua-2/400/400',
    ],
  ...
  },
  {
    ...
    spirit: 4,
    woundPhotos: [
      'https://picsum.photos/seed/wound-dahuang-1/400/400',
    ],
  ...
  },
  {
    ...
    spirit: 5,
    woundPhotos: [
      'https://picsum.photos/seed/wound-dahuang-3/400/400',
      'https://picsum.photos/seed/wound-dahuang-4/400/400',
      'https://picsum.photos/seed/wound-dahuang-5/400/400',
    ],
    medication: '继续碘伏消毒',
    defecation: '正常',
  ...
  },
  {
    ...
    spirit: 2,
    woundPhotos: [
      'https://picsum.photos/seed/wound-xiaobai-1/400/400',
    ],
    medication: '止痛药，消炎药',
    defecation: '较少',
  ...
  },
  {
    ...
    spirit: 4,
    woundPhotos: [
      'https://picsum.photos/seed/wound-xiaobai-2/400/400',
      'https://picsum.photos/seed/wound-xiaobai-3/400/400',
    ],
    medication: '继续用药',
    defecation: '恢复正常',
    abnormalDesc: '',
