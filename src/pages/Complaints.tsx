...
export default function Complaints() {
  const { complaints, orders, boxes, addComplaint, getOrdersByBatchNo, getStationById } = useStore()
  ...
  const orderExists = orders.some((o) => o.orderNo === orderNo.trim())
      ...
      <div className="bg-white rounded-xl shadow-sm border border-tea-100 p-6 mb-6">
        ...
        <form onSubmit={handleSubmit} className="flex items-end gap-4">
          <div className="flex-1">
            ...
            {orderNo && !orderExists && (
              <p className="text-xs text-danger mt-1">未找到该订单</p>
            )}
          </div>
          <div>
            ...
            <select
              ...
              className="px-4 py-2.5 rounded-lg border border-tea-200 text-sm focus:outline-none focus:ring-2 focus:ring-amber/30 focus:border-amber"
            >
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                ...
                {complaints.length === 0 && (
                  <tr>
                    <td colSpan={5} className="py-8 text-center text-tea-400 text-xs">暂无客诉记录</td>
                  </tr>
                )}
              </tbody>
            </table>
