                      ...
                      >
                        ...
                        <div className="space-y-3">
                          ...
                          <button
                            ...
                            className="w-full text-xs px-3 py-2 bg-forest/10 text-forest rounded-lg hover:bg-forest/20 transition-colors flex items-center justify-center gap-1"
                          >
                      ...
                      >
                        ...
                        <div className="text-xs text-gray-500 mb-3 space-y-1">
                          <p className="flex items-center gap-1">
                            <MapPin className="w-3 h-3 text-rose-gold flex-shrink-0" />
                            <span className="truncate">{node?.name} · {task.location}</span>
                          </p>
                          <p className="flex items-center gap-1">
                            <Clock className="w-3 h-3 text-champagne-gold flex-shrink-0" />
                        ...
                        <div className="space-y-3">
                          ...
                          <button
                            onClick={() => updateTaskStatus(task.id, 'confirmed')}
                            className="w-full text-xs px-3 py-2 bg-champagne-gold/10 text-champagne-gold rounded-lg hover:bg-champagne-gold/20 transition-colors flex items-center justify-center gap-1"
                          >
                            <CheckCircle className="w-3.5 h-3.5" />
                            确认任务
                          </button>
