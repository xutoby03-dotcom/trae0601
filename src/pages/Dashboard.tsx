...
import { Users, CreditCard, AlertTriangle, Clock, Bell } from 'lucide-react';
          ...
          <div className="card p-5">
            ...
            <div className="space-y-3 text-sm text-neutral-600">
              ...
              <div className="flex items-start gap-3">
                ...
                <p>超时未归还将自动生成提醒，同步发送前台和接待人</p>
              </div>
              <div className="flex items-start gap-3">
                <span className="w-6 h-6 rounded-full bg-success/10 text-success flex items-center justify-center text-xs font-bold shrink-0">
                  4
                </span>
                <p>处理超时提醒后点击「已处理」移出待处理列表</p>
              </div>
              <div className="flex items-start gap-3">
                <span className="w-6 h-6 rounded-full bg-warning/10 text-warning flex items-center justify-center text-xs font-bold shrink-0">
                  !
                </span>
